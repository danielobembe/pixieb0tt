...
def getEventTypes():
    ...
    #print(json.dumps(eventTypeLoads,sort_keys=True,indent=4,separators=(',',': ')))
...
def getMarketCatalogueForNextGBWin(eventTypeID):
    ...
    if (eventTypeID is not None):
        ...
        #print(json.dumps(market_catalogue_response,sort_keys=True,indent=4,separators=(',',': ')))
        market_catalouge_loads = json.loads(market_catalogue_response)
        try:
            market_catalouge_results = market_catalouge_loads['result']
            #print(json.dumps(market_catalouge_results,sort_keys=True,indent=4,separators=(',',': ')))
...
"""
    ...
    try:
        ...
        #print(json.dumps(market_book_result,sort_keys=True,indent=4,separators=(',',': ')))
...
headers = {'X-Application':login_info['app_key_delay'] , 'X-Authentication': 'fTbtN79OyfM21M4bCX7Mv9oL1TUN9AoTWqwnKLIK06U=', 'content-type': 'application/json'}
...
#Next step assumes I know names of markets. How do I get names of markets?
